...
const PRODUCTS: ProductType[] = [
  ...
  {
    name: "Четыре сыра с медом",
    image: CheeseHoney,
    price: 475,
    description:
      "Моцарелла, смесь сыров чеддер и пармезан, сыр блю чиз, соус альфредо",
  },
  {
    name: "Овощи и грибы",
    image: VegaMashrooms,
    price: 445,
    description:
      "Моцарелла, кубики брынзы, томаты, маслины, шампиньоны, сладкий перец, красный лук, итальянские травы, томатный соус",
  },
  {
    name: "Песто",
    image: Pesto,
